            ...
            class baseTabs extends elementorModules.frontend.handlers.Base {
                ...
                handleKeyboardNavigation(e) {
                    ...
                    switch (e.key) {
                        ...
                        case "ArrowDown":
                            ...
                            break;
                        case "Home":
                            return e.preventDefault(), void s.first().focus();
                        case "End":
                            return e.preventDefault(), void s.last().focus();
                        default:
                            return
                    }
                    const n = t.getAttribute("data-tab") - 1,
                        ...
                        o = s[n + r];
                    o ? o.focus() : -1 === n + r ? s.last().focus() : s.first().focus()
                }
                ...
                activateTab(e) {
                    ...
                    s.add(i).addClass(a), s.attr({
                        ...
                        "aria-selected": "true",
                        "aria-expanded": "true"
                    }), i[t.showTabFn](n, (() => elementorFrontend.elements.$window.trigger("resize"))), i.removeAttr("hidden")
                }
                isActiveTab(e) {
